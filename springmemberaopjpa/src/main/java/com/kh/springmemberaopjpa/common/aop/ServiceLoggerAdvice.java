package com.kh.springmemberaopjpa.common.aop;
...
public class ServiceLoggerAdvice {
    ...
    // @After("execution(* com.kh.springmemberaopjpa.service.MemberDAOService*.*(..))") // Point cut
    ...
    @Around("execution(* com.kh.springmemberaopjpa.service.MemberDAOService*.*(..))")
